...
# SPDX-FileCopyrightText: 2022 Narknon
...
if(DEFINED ENV{XWIN_DIR})
    ...
    get_filename_component(XWIN_CACHE_DIR "${CMAKE_SOURCE_DIR}/.xwin" ABSOLUTE)
endif()
...
execute_process(
    COMMAND clang-cl /clang:-print-resource-dir
...
set(CMAKE_RC_FLAGS "${SYSTEM_INCLUDE_FLAGS}")
